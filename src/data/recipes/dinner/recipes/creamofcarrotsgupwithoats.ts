...
export const creamofcarrotsgupwithoats: Recipe = {
  name: 'Creamofcarrotsgupwithoats',
  ...
  ingredients: [
    ...
    { name: 'tablespoonschoppeddno.2saounce Forgamish', amount: 1.0 },
    { name: 'o.sini Ganonpot Heatonovermediumfiame Addonionsandsait Sweatuntilonionsare', amount: 1.0 },
  ...
  instructions: [
    ...
    'Add stock and oats to pot. Raise heat and bring soup to boil. Reduce heat and simmer',
