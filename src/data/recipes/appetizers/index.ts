...
export const appetizerRecipes: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'kombu', amount: 2, unit: '' },
      { name: 'water', amount: 20, unit: 'cup' },
      { name: 'onion (½ large, peeled and chopped)', amount: 0.5, unit: 'lb' },
      { name: 'carrot (1 large, peeled and chopped)', amount: 0.5, unit: 'lb' },
      { name: 'fennel bulb (chopped)', amount: 1, unit: 'lb' },
      { name: 'olive oil', amount: 1.25, unit: 'tbsp' },
      { name: 'tomatoes (seeded and chopped)', amount: 1.5, unit: 'lb' },
      { name: 'garlic (sliced)', amount: 8, unit: '' },
      { name: 'button mushrooms (sliced)', amount: 2, unit: 'lb' },
