...
export const creamofcarrotsoupwithpotato: Recipe = {
  name: 'Creamofcarrotsoupwithpotato',
  ...
  ingredients: [
    ...
    { name: 'o.siargeonion 2ounces)', amount: 1.0 },
    { name: 'Y Teaspeonseasait', amount: 1.0 },
    { name: 'Poundscarrots Peeled Ia Inchrounds', amount: 1.0 },
    { name: 'S Gcupsstock', amount: 4.0, unit: 'cups' },
    { name: 'Ouncespotato aamedium)', amount: 1.0 },
  ...
  instructions: [
    ...
    'Add stock and potatoes to pot. Raise heat and bring soup to boil. Reduce heat and simmer',
